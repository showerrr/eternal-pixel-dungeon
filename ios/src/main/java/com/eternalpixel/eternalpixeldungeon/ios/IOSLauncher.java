package com.eternalpixel.eternalpixeldungeon.ios;
...
public class IOSLauncher extends IOSApplication.Delegate {
	...
	protected IOSApplication createApplication() {
		...
		//this is mostly a copy-paste from IOSApplication.getPreferences
			...
			File finalPath = new File(libraryPath, EPDSettings.DEFAULT_PREFS_FILE + ".plist");
			...
			EPDSettings.set(new IOSPreferences(nsDictionary, finalPath.getAbsolutePath()));
		//end of prefs setup
		...
		config.hideHomeIndicator = EPDSettings.fullscreen();
		config.overrideRingerSwitch = EPDSettings.ignoreSilentMode();
		...
		return new IOSApplication(new EternalPixelDungeon(new IOSPlatformSupport()), config);
	}
