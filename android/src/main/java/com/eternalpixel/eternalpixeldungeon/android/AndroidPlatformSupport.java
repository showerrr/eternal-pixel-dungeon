...
public class AndroidPlatformSupport extends PlatformSupport {
	...
	public void updateDisplaySize(){
		if (EPDSettings.landscape() != null) {
			AndroidGame.instance.setRequestedOrientation( EPDSettings.landscape() ?
		...
		if (fullscreen && EPDSettings.landscape() != null
				&& (Game.dispWidth >= Game.dispHeight) != EPDSettings.landscape()){
		...
		if (Game.dispWidth < renderWidth*2 || Game.dispHeight < renderHeight*2)
			EPDSettings.put( EPDSettings.KEY_POWER_SAVER, true );
		
		if (EPDSettings.powerSaver() && fullscreen){
