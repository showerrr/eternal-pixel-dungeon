...
package com.eternalpixel.eternalpixeldungeon.android;
...
public class AndroidGame extends AndroidApplication {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		if (instance == null) {
			...
			EPDSettings.set(instance.getPreferences("EternalPixelDungeon"));
		...
		if (EPDSettings.landscape() != null) {
			instance.setRequestedOrientation( EPDSettings.landscape() ?
		...
		initialize(new EternalPixelDungeon(support), config);
