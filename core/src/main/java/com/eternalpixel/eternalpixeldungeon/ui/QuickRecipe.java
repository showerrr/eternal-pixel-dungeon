...
import com.eternalpixel.eternalpixeldungeon.items.ArcaneResin;
...
import com.eternalpixel.eternalpixeldungeon.items.bombs.Bomb;
import com.eternalpixel.eternalpixeldungeon.items.food.Blandfruit;
import com.eternalpixel.eternalpixeldungeon.items.food.Food;
import com.eternalpixel.eternalpixeldungeon.items.food.MeatPie;
...
import com.eternalpixel.eternalpixeldungeon.items.food.StewedMeat;
...
import com.eternalpixel.eternalpixeldungeon.items.potions.brews.BlizzardBrew;
import com.eternalpixel.eternalpixeldungeon.items.potions.brews.CausticBrew;
import com.eternalpixel.eternalpixeldungeon.items.potions.brews.InfernalBrew;
import com.eternalpixel.eternalpixeldungeon.items.potions.brews.ShockingBrew;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfAquaticRejuvenation;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfArcaneArmor;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfDragonsBlood;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfHoneyedHealing;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfIcyTouch;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfToxicEssence;
...
import com.eternalpixel.eternalpixeldungeon.items.spells.Alchemize;
import com.eternalpixel.eternalpixeldungeon.items.spells.AquaBlast;
import com.eternalpixel.eternalpixeldungeon.items.spells.ArcaneCatalyst;
import com.eternalpixel.eternalpixeldungeon.items.spells.BeaconOfReturning;
import com.eternalpixel.eternalpixeldungeon.items.spells.CurseInfusion;
import com.eternalpixel.eternalpixeldungeon.items.spells.FeatherFall;
import com.eternalpixel.eternalpixeldungeon.items.spells.MagicalInfusion;
import com.eternalpixel.eternalpixeldungeon.items.spells.PhaseShift;
import com.eternalpixel.eternalpixeldungeon.items.spells.ReclaimTrap;
import com.eternalpixel.eternalpixeldungeon.items.spells.Recycle;
import com.eternalpixel.eternalpixeldungeon.items.spells.SummonElemental;
import com.eternalpixel.eternalpixeldungeon.items.spells.TelekineticGrab;
import com.eternalpixel.eternalpixeldungeon.items.spells.WildEnergy;
...
public class QuickRecipe extends Component {
	...
	public QuickRecipe(Recipe r, ArrayList<Item> inputs, final Item output) {
		...
		for (final Item in : inputs) {
			...
			curr = new ItemSlot(in) {
				...
				protected void onClick() {
					EternalPixelDungeon.scene().addToFront(new WndInfoItem(in));
				}
			};
		...
		this.output = new ItemSlot(output){
			@Override
			protected void onClick() {
				EternalPixelDungeon.scene().addToFront(new WndInfoItem(output));
			}
		};
		if (!hasInputs){
	...
	public class arrow extends IconButton {
		...
		protected void onClick() {
			...
			((AlchemyScene) EternalPixelDungeon.scene()).populate(ingredients, Dungeon.hero.belongings);
		}
