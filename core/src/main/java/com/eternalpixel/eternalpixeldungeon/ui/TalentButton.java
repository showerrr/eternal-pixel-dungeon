...
import com.eternalpixel.eternalpixeldungeon.windows.WndInfoTalent;
...
public class TalentButton extends Button {
	...
	protected void onClick() {
		...
		if (mode == Mode.UPGRADE
			...
			EternalPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, new WndInfoTalent.TalentButtonCallback() {
			...
			EternalPixelDungeon.scene().addToFront(new WndInfoTalent(talent, pointsInTalent, null));
		}
	}
