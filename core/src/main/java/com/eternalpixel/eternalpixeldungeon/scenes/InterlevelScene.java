...
import com.eternalpixel.eternalpixeldungeon.items.LostBackpack;
...
import com.eternalpixel.eternalpixeldungeon.windows.WndError;
	...
	public void update() {
		...
		case STATIC:
			if (error != null) {
				...
				EternalPixelDungeon.reportException(
