...
import com.eternalpixel.eternalpixeldungeon.ui.ScrollPane;
...
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_1_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_2_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_3_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_4_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_5_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_6_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_7_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_8_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v0_9_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.SPDchangelist.v1_X_Changes;
import com.eternalpixel.eternalpixeldungeon.ui.changelist.v01X;
...
public class ChangesScene extends PixelScene {
	...
	public void create() {
		...
		switch (changesSelected){
			case 0: default:
				v01X.addAllChanges(changeInfos);
				break;
			case 1:
		...
		StyledButton btn01x = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "EPD"){
			@Override
		...
		if (changesSelected != 0) btn01x.textColor( 0xBBBBBB );
		btn01x.setRect(list.left()-4f, list.bottom(), 22, changesSelected == 0 ? 19 : 15);
		addToBack(btn01x);

		StyledButton btn1_1 = new StyledButton(Chrome.Type.GREY_BUTTON_TR, "SPD"){
			@Override
			protected void onClick() {
				super.onClick();
		...
		btn1_1.setRect(btn01x.right() + 1, btn01x.top(), 22, changesSelected == 1 ? 19 : 15);
		addToBack(btn1_1);
