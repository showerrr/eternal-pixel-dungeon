...
import com.eternalpixel.eternalpixeldungeon.actors.buffs.ChampionEnemy;
import com.eternalpixel.eternalpixeldungeon.actors.hero.Talent;
import com.eternalpixel.eternalpixeldungeon.actors.mobs.DemonSpawner;
...
import com.eternalpixel.eternalpixeldungeon.effects.BlobEmitter;
import com.eternalpixel.eternalpixeldungeon.effects.CircleArc;
import com.eternalpixel.eternalpixeldungeon.effects.EmoIcon;
import com.eternalpixel.eternalpixeldungeon.effects.Flare;
import com.eternalpixel.eternalpixeldungeon.effects.FloatingText;
import com.eternalpixel.eternalpixeldungeon.effects.Ripple;
...
import com.eternalpixel.eternalpixeldungeon.items.Honeypot;
...
import com.eternalpixel.eternalpixeldungeon.journal.Journal;
import com.eternalpixel.eternalpixeldungeon.levels.Level;
import com.eternalpixel.eternalpixeldungeon.levels.RegularLevel;
import com.eternalpixel.eternalpixeldungeon.levels.rooms.Room;
import com.eternalpixel.eternalpixeldungeon.levels.rooms.secret.SecretRoom;
...
import com.eternalpixel.eternalpixeldungeon.sprites.DiscardedItemSprite;
...
import com.eternalpixel.eternalpixeldungeon.tiles.CustomTilemap;
import com.eternalpixel.eternalpixeldungeon.tiles.DungeonTerrainTilemap;
import com.eternalpixel.eternalpixeldungeon.tiles.DungeonTileSheet;
import com.eternalpixel.eternalpixeldungeon.tiles.DungeonTilemap;
import com.eternalpixel.eternalpixeldungeon.tiles.DungeonWallsTilemap;
import com.eternalpixel.eternalpixeldungeon.tiles.FogOfWar;
import com.eternalpixel.eternalpixeldungeon.tiles.GridTileMap;
import com.eternalpixel.eternalpixeldungeon.tiles.RaisedTerrainTilemap;
import com.eternalpixel.eternalpixeldungeon.tiles.TerrainFeaturesTilemap;
import com.eternalpixel.eternalpixeldungeon.tiles.WallBlockingTilemap;
import com.eternalpixel.eternalpixeldungeon.ui.ActionIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.AttackIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.Banner;
import com.eternalpixel.eternalpixeldungeon.ui.BusyIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.CharHealthIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.GameLog;
import com.eternalpixel.eternalpixeldungeon.ui.Icons;
import com.eternalpixel.eternalpixeldungeon.ui.LootIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.QuickSlotButton;
import com.eternalpixel.eternalpixeldungeon.ui.ResumeIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.StatusPane;
import com.eternalpixel.eternalpixeldungeon.ui.Tag;
import com.eternalpixel.eternalpixeldungeon.ui.TargetHealthIndicator;
import com.eternalpixel.eternalpixeldungeon.ui.Toast;
import com.eternalpixel.eternalpixeldungeon.ui.Toolbar;
...
import com.eternalpixel.eternalpixeldungeon.windows.WndInfoCell;
import com.eternalpixel.eternalpixeldungeon.windows.WndInfoItem;
import com.eternalpixel.eternalpixeldungeon.windows.WndInfoMob;
import com.eternalpixel.eternalpixeldungeon.windows.WndInfoPlant;
import com.eternalpixel.eternalpixeldungeon.windows.WndInfoTrap;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		EPDSettings.lastClass(Dungeon.hero.heroClass.ordinal());
		
		super.create();
		Camera.main.zoom( GameMath.gate(minZoom, defaultZoom + EPDSettings.zoom(), maxZoom));
		...
		if (InterlevelScene.mode != InterlevelScene.Mode.NONE) {
			if (Dungeon.depth == Statistics.deepestFloor
				...
				if (Dungeon.depth == 0) {
					GLog.h(Messages.get(this, "town_descend"), Dungeon.depth);
				} else {
				...
				if (Dungeon.depth == 0) {
					GLog.h(Messages.get(this, "town_resurrect"), Dungeon.depth);
				} else {
					GLog.h(Messages.get(this, "resurrect"), Dungeon.depth);
				}
			} else {
				if (Dungeon.depth == 0) {
					GLog.h(Messages.get(this, "town_return"), Dungeon.depth);
				} else {
