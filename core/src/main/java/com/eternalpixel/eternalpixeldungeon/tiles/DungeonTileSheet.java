...
package com.eternalpixel.eternalpixeldungeon.tiles;
...
public class DungeonTileSheet {
	...
	public static final int TOWNEXIT        = GROUND +0;
	...
	public static HashSet<Integer> waterStitcheable = new HashSet<>(Arrays.asList(
			...
			Terrain.ENTRANCE, Terrain.EXIT, Terrain.TOWNEXIT, Terrain.EMBERS,
	...
	static {
		...
		directVisuals.put(Terrain.TOWNEXIT,         TOWNEXIT);
