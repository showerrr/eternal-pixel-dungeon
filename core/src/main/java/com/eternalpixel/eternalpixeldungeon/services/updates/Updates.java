...
package com.eternalpixel.eternalpixeldungeon.services.updates;
...
public class Updates {
	...
	public static void checkForUpdate(){
		...
		if (EPDSettings.betas()){
			EPDSettings.betas(true);
		}

		service.checkForUpdate(!EPDSettings.WiFi(), EPDSettings.betas(), new UpdateService.UpdateResultCallback() {
			@Override
