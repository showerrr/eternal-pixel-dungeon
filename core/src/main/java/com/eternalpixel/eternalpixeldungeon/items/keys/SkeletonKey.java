...
package com.eternalpixel.eternalpixeldungeon.items.keys;
...
import com.eternalpixel.eternalpixeldungeon.windows.WndSupportPrompt;
...
public class SkeletonKey extends Key {
	...
	public boolean doPickUp(Hero hero, int pos) {
		if(!EPDSettings.supportNagged()){
			try {
				Dungeon.saveAll();
				Game.runOnRenderThread(new Callback() {
					@Override
					public void call() {
						EternalPixelDungeon.scene().add(new WndSupportPrompt());
					}
				});
			} catch (IOException e) {
