...
package com.eternalpixel.eternalpixeldungeon.sprites;
...
public class ItemSpriteSheet {
	...
	public static final int FIREWORK        = UNCOLLECTIBLE+2;
	...
	public static final int SIGH            = CONTAINERS+8;
	static{
	...
	private static final int COOKINGTOOLS  		=                               xy(1,6);
	public static final int CAMPFIRE 			= COOKINGTOOLS+0;
	public static final int POT 				= COOKINGTOOLS+1;
	public static final int PORTABLECOOKINGTOOL = COOKINGTOOLS+2;
	public static final int SINK 				= COOKINGTOOLS+3;
	public static final int KITCHENOVEN 		= COOKINGTOOLS+4;
	public static final int KITCHEN 			= COOKINGTOOLS+5;
	public static final int OVEN 				= COOKINGTOOLS+6;
	public static final int FOODPROCESSOR 		= COOKINGTOOLS+7;
	public static final int FOODMAKER 			= COOKINGTOOLS+8;
	public static final int BARBECUESET 		= COOKINGTOOLS+9;
	public static final int JUICEMIXER 			= COOKINGTOOLS+10;
	static {
		assignItemRect(CAMPFIRE, 			12,15);
		assignItemRect(POT,					16,11);
		assignItemRect(PORTABLECOOKINGTOOL, 16,12);
		assignItemRect(SINK,				16,13);
		assignItemRect(KITCHENOVEN,			16,16);
		assignItemRect(KITCHEN,				16,13);
		assignItemRect(OVEN,				16,16);
		assignItemRect(FOODPROCESSOR,		13,15);
		assignItemRect(FOODMAKER,			12,16);
		assignItemRect(BARBECUESET,			16,10);
		assignItemRect(JUICEMIXER,			 9,16);
	}
	                                                                                    //16 free slots
	...
	public static final int DIVINATION      = WEP_TIER1+3;
	...
	static{
		...
		assignItemRect(DIVINATION,15,15);
	...
	private static final int OTHERS           	      =                           xy(10, 12);  //16 slots
	public static final int HEAD_MAGABYSS    		  = OTHERS+0;
	public static final int NECK_TWINEDGE             = OTHERS+1;
	public static final int BACK_METALWINGOFVESDA     = OTHERS+2;
	public static final int ARM_BLUESPIRIT            = OTHERS+3;
	public static final int WAIST_CRIMSONPLATE        = OTHERS+4;
	public static final int LEG_DALITHALION           = OTHERS+5;
	public static final int SHOOT_GEMINI              = OTHERS+6;
	static {
		assignItemRect(HEAD_MAGABYSS, 16, 14);
		assignItemRect(NECK_TWINEDGE, 16, 16);
		assignItemRect(BACK_METALWINGOFVESDA, 15, 15);
		assignItemRect(ARM_BLUESPIRIT, 16, 16);
	}


	private static final int VEGETABLE 		 =                                           xy(1,13);
	public static final int POTATO     		 = VEGETABLE+0;
	public static final int GREEN_PEA   	 = VEGETABLE+1;
	public static final int TOMATO     	 	 = VEGETABLE+2;
	public static final int MELON      	 	 = VEGETABLE+3;
	public static final int LECCHO     		 = VEGETABLE+4;
	public static final int SWEET_POTATO	 = VEGETABLE+5;
	public static final int SQUASH 	   		 = VEGETABLE+6;
	public static final int EDIBLE_WILD_PLANT= VEGETABLE+7;
	public static final int LETTUCE          = VEGETABLE+8;
	public static final int TARO 			 = VEGETABLE+9;
	public static final int HEALTHY_LEAF     = VEGETABLE+10;
	static {
		assignItemRect(POTATO,13,14);
		assignItemRect(GREEN_PEA,16,16);
		assignItemRect(TOMATO,13,12);
		assignItemRect(MELON,16,16);
		assignItemRect(LECCHO,15,11);
		assignItemRect(SWEET_POTATO,16,16);
		assignItemRect(SQUASH,16,16);
		assignItemRect(EDIBLE_WILD_PLANT,13,16);
		assignItemRect(LETTUCE,16,16);
		assignItemRect(TARO,16,16);
		assignItemRect(HEALTHY_LEAF,16,14);
	}
	...
	private static final int VEGETABLEFOOD  =                               xy(1,18);
	public static final int KITCHENREFUSEVEGETABLE        =VEGETABLEFOOD+0;
	public static final int SMELLYVEGETABLE               =VEGETABLEFOOD+1;
	public static final int VEGETABLESALAD                =VEGETABLEFOOD+2;
	public static final int FRIEDVEGETABLE                =VEGETABLEFOOD+3;
	public static final int VEGETABLEROLL                 =VEGETABLEFOOD+4;
	public static final int VEGETABLETENPURA              =VEGETABLEFOOD+5;
	public static final int VEGETABLEGRATIN               =VEGETABLEFOOD+6;
	public static final int MEATANDVEGETABLESTEW          =VEGETABLEFOOD+7;
	public static final int VEGETABLECURRY                =VEGETABLEFOOD+8;
	static {
		assignItemRect(KITCHENREFUSEVEGETABLE , 15, 16);
		assignItemRect(SMELLYVEGETABLE, 		16, 12);
		assignItemRect(VEGETABLESALAD , 		16, 12);
		assignItemRect(FRIEDVEGETABLE, 			16, 12);
		assignItemRect(VEGETABLEROLL , 			16, 12);
		assignItemRect(VEGETABLETENPURA, 		16, 16);
		assignItemRect(VEGETABLEGRATIN , 		16, 12);
		assignItemRect(MEATANDVEGETABLESTEW, 	16, 13);
		assignItemRect(VEGETABLECURRY, 			16, 11);
	}
	                                                                                    //16 free slots
	...
	private static final int DRINK          =                               xy(1,26);
	public static final int MILK            = DRINK+0;
	public static final int JUICE			= DRINK+1;
	static {
		assignItemRect(MILK,14,14);
		assignItemRect(JUICE,8,16);
	}                                                                              //16 free slots
	...
	public static final int SOUPOFWONDERLAND     = FOOD+13;
	public static final int ROTTENFOOD           = FOOD+14;
	static{
		...
		assignItemRect(SOUPOFWONDERLAND,    16, 13);
		assignItemRect(ROTTENFOOD,          16, 14);
	}
	...
	private static final int FLOURFOOD            =                         xy(1, 30);  //16 slots
	public static final int FLOUR                 = FLOURFOOD+0;//use the same image
	public static final int FEARSOMEBREAD         = FLOURFOOD+1;
	public static final int HARDBREAD             = FLOURFOOD+2;
	public static final int WALNUTBREAD           = FLOURFOOD+3;
	public static final int APPLEPIE              = FLOURFOOD+4;
	public static final int SANDWICH              = FLOURFOOD+5;
	public static final int CROISSANT             = FLOURFOOD+6;
	public static final int CROQUETTESANDWICH     = FLOURFOOD+7;
	public static final int CHOCOLATEBABKA        = FLOURFOOD+8;
	public static final int MELONFLAVOREDBREAD    = FLOURFOOD+9;
	static{
		assignItemRect(FLOUR               ,   16,  15);
		assignItemRect(FEARSOMEBREAD       ,   16,  15);
		assignItemRect(HARDBREAD           ,   16,  16);
		assignItemRect(WALNUTBREAD         ,   16,  13);
		assignItemRect(APPLEPIE            ,   16,  13);
		assignItemRect(SANDWICH            ,   15,  16);
		assignItemRect(CROISSANT           ,   15,  12);
		assignItemRect(CROQUETTESANDWICH   ,   16,  16);
		assignItemRect(CHOCOLATEBABKA      ,   16,  10);
		assignItemRect(MELONFLAVOREDBREAD  ,   16,  13);
	}
	...
	public static final int COOLERBOX   = BAGS+6;
	static{
		...
		assignItemRect(COOLERBOX,   16, 14);
	}

	private static final int NOODLE         =                               xy(1, 32);
	public static final int RAWNOODLE       = NOODLE+0;
	public static final int RISKYNOODLE     = NOODLE+1;
	public static final int EXHAUSTEDNOODLE = NOODLE+2;
	public static final int SALADPASTA      = NOODLE+3;
	public static final int UDON  			= NOODLE+4;
	public static final int SOBA   			= NOODLE+5;
	public static final int PEPERONCINO  	= NOODLE+6;
	public static final int CARBONARA  		= NOODLE+7;
	public static final int RAMEN  			= NOODLE+8;
	public static final int MEATSPAGHETTI   = NOODLE+9;
	static{
		assignItemRect(RAWNOODLE,       16, 15);
		assignItemRect(RISKYNOODLE,     16, 11);
		assignItemRect(EXHAUSTEDNOODLE, 16, 12);
		assignItemRect(SALADPASTA,      16, 14);
		assignItemRect(UDON,     		16, 14);
		assignItemRect(SOBA,            16, 14);
		assignItemRect(PEPERONCINO,     16, 12);
		assignItemRect(CARBONARA,  		16, 12);
		assignItemRect(RAMEN,   		16, 13);
		assignItemRect(MEATSPAGHETTI,   16, 11);
	}


	private static final int RAWMEAT  				=                                      xy(1,33);
	public static final int CORPSE    				= RAWMEAT+0;
	public static final int GROTESQUEMEAT    		= RAWMEAT+1;
	public static final int CHARREDMEAT    			= RAWMEAT+2;
	public static final int ROASTMEAT    			= RAWMEAT+3;
	public static final int DEEPFRIEDMEAT    		= RAWMEAT+4;
	public static final int SKEWERGRILLEDMEAT  		= RAWMEAT+5;
	public static final int MEATCROQUETTE    		= RAWMEAT+6;
	public static final int MEATHAMBURGER    		= RAWMEAT+7;
	public static final int MEATCUTLET    			= RAWMEAT+8;
	public static final int MEATSTEAK    			= RAWMEAT+9;
	static {
		assignItemRect(CORPSE,15,11);
		assignItemRect(GROTESQUEMEAT,16,12);
		assignItemRect(CHARREDMEAT,16,12);
		assignItemRect(ROASTMEAT,16,16);
		assignItemRect(DEEPFRIEDMEAT,16,12);
		assignItemRect(SKEWERGRILLEDMEAT,16,12);
		assignItemRect(MEATCROQUETTE,16,12);
		assignItemRect(MEATHAMBURGER,16,12);
		assignItemRect(MEATCUTLET,16,12);
		assignItemRect(MEATSTEAK,16,16);
	}


	private static final int FURNITURE  				=                                      xy(1,34);
	public static final int BOOKSHELF = FURNITURE+0;
	public static final int BIG_BOOKSHELF = FURNITURE+1;
	public static final int BUSH = FURNITURE+2;
	public static final int WOODEN_TABLE = FURNITURE+3;
	public static final int BAGUETTE = FURNITURE+4;
	static {
		assignItemRect(BOOKSHELF,12,16);
		assignItemRect(BIG_BOOKSHELF,16,16);
		assignItemRect(BUSH,16,16);
		assignItemRect(WOODEN_TABLE,16,16);
		assignItemRect(BAGUETTE,9,16);
	}


	private static final int STH_BIG  				=                                      xy(1,35);
	public static final int STREETLAMP = STH_BIG+0;
	public static final int FLOWER_GATE = STH_BIG+1;
	public static final int WOODEN_DUMMY = STH_BIG+2;
	static {
		assignItemRect(STREETLAMP,16,32);
		assignItemRect(FLOWER_GATE,16,32);
		assignItemRect(WOODEN_DUMMY,16,31);
	}


	private static final int AMMO		  				=                                      xy(1,37);
	public static final int ENERGY_CELL = AMMO+0;
	public static final int BULLET = AMMO+1;
	public static final int ARROW = AMMO+2;
	public static final int ENERGY_CELL_EFFECT = AMMO+3;
	public static final int AMMOS_BOX = AMMO+4;
	static {
		assignItemRect(ENERGY_CELL,12,12);
		assignItemRect(BULLET,8,12);
		assignItemRect(ARROW,12,12);
		assignItemRect(ENERGY_CELL_EFFECT,14,14);
		assignItemRect(AMMOS_BOX,16,13);
	}


	private static final int SHOOT		  				=                                      xy(1,38);
	public static final int LASER_GUN = SHOOT+0;
	public static final int LONG_BOW = SHOOT+1;
	static {
		assignItemRect(LASER_GUN,16,10);
		assignItemRect(LONG_BOW,14,14);
	}

	private static final int TAROTS 					=										xy(1,39);
	public static final int TAROT = TAROTS+0;
	public static final int TAROT0 = TAROTS+1;
