...
import com.eternalpixel.eternalpixeldungeon.scenes.StartScene;
	...
	public WndGameInProgress(final int slot){
		...
		Button debug = new Button(){
			...
			protected boolean onLongClick() {
				try {
					...
					EternalPixelDungeon.scene().addToFront(new WndMessage("_Debug Info:_\n\n" +
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				EternalPixelDungeon.switchScene(InterlevelScene.class);
			}
		};
		...
		RedButton erase = new RedButton( Messages.get(this, "erase")){
			...
			protected void onClick() {
				...
				EternalPixelDungeon.scene().add(new WndOptions(Icons.get(Icons.WARNING),
