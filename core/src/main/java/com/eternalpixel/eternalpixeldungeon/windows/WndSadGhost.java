...
import com.eternalpixel.eternalpixeldungeon.sprites.FetidRatSprite;
import com.eternalpixel.eternalpixeldungeon.sprites.GnollTricksterSprite;
import com.eternalpixel.eternalpixeldungeon.sprites.GreatCrabSprite;
		...
		public RewardButton( Item item ){
			...
			slot = new ItemSlot( item ){
				...
				protected void onClick() {
					EternalPixelDungeon.scene().addToFront(new RewardWindow(item));
				}
			};
			add(slot);
		}
