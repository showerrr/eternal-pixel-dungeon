...
public class WndBlackJack extends Window {
    ...
    public WndBlackJack(boolean endGame) {
        ...
        if (!endGame) {
            ...
            String yes = BlackJack.PCnum == 0?"整多啦":"再整一张";
            ...
            String no = BlackJack.PCnum >= 21?"整够了":"不整了";
            ...
            RedButton btnAgain = new RedButton("再来一把") {
                @Override
                protected void onClick() {
                    hide();
                    BlackJack.gameStart();
            ...
            RedButton btnClose = new RedButton("不玩了") {
                @Override
                protected void onClick() {
                    hide();
                }
