...
public class Hunger extends Buff implements Hero.Doom {
	...
	public static final float OVERFEED	= 1200f;
	public static final float SATISFIED	= 1000f;
	public static final float BLOATED	= 600f;

	public static final float HUNGRY	= 400f;
	public static final float STARVING	= 200f;
	public static final float DYING	= 100f;
