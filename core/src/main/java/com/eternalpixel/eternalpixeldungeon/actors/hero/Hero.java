...
import com.eternalpixel.eternalpixeldungeon.actors.buffs.AdrenalineSurge;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Amok;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.AnkhInvulnerability;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Awareness;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Barkskin;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Berserk;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Bless;
...
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Foresight;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.HoldFast;
...
import com.eternalpixel.eternalpixeldungeon.actors.buffs.MindVision;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Momentum;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Paralysis;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Regeneration;
import com.eternalpixel.eternalpixeldungeon.actors.buffs.SnipersMark;
...
import com.eternalpixel.eternalpixeldungeon.actors.mobs.Monk;
import com.eternalpixel.eternalpixeldungeon.actors.mobs.Snake;
import com.eternalpixel.eternalpixeldungeon.actors.mobs.YogDzewa;
import com.eternalpixel.eternalpixeldungeon.effects.CheckedCell;
import com.eternalpixel.eternalpixeldungeon.effects.SpellSprite;
import com.eternalpixel.eternalpixeldungeon.items.Amulet;
import com.eternalpixel.eternalpixeldungeon.items.Ankh;
import com.eternalpixel.eternalpixeldungeon.items.Dewdrop;
import com.eternalpixel.eternalpixeldungeon.items.EquipableItem;
import com.eternalpixel.eternalpixeldungeon.items.Heap;
import com.eternalpixel.eternalpixeldungeon.items.Heap.Type;
import com.eternalpixel.eternalpixeldungeon.items.Item;
import com.eternalpixel.eternalpixeldungeon.items.KindOfWeapon;
...
import com.eternalpixel.eternalpixeldungeon.items.armor.glyphs.Brimstone;
import com.eternalpixel.eternalpixeldungeon.items.armor.glyphs.Viscosity;
...
import com.eternalpixel.eternalpixeldungeon.items.keys.IronKey;
import com.eternalpixel.eternalpixeldungeon.items.keys.Key;
import com.eternalpixel.eternalpixeldungeon.items.keys.SkeletonKey;
...
import com.eternalpixel.eternalpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.eternalpixel.eternalpixeldungeon.items.potions.exotic.PotionOfDivineInspiration;
...
import com.eternalpixel.eternalpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.eternalpixel.eternalpixeldungeon.journal.Notes;
import com.eternalpixel.eternalpixeldungeon.levels.Level;
import com.eternalpixel.eternalpixeldungeon.levels.Terrain;
import com.eternalpixel.eternalpixeldungeon.levels.features.Chasm;
import com.eternalpixel.eternalpixeldungeon.levels.features.Sign;
import com.eternalpixel.eternalpixeldungeon.levels.traps.Trap;
import com.eternalpixel.eternalpixeldungeon.mechanics.ShadowCaster;
...
import com.eternalpixel.eternalpixeldungeon.scenes.SurfaceScene;
...
import com.eternalpixel.eternalpixeldungeon.ui.AttackIndicator;
...
import com.eternalpixel.eternalpixeldungeon.ui.StatusPane;
...
import com.eternalpixel.eternalpixeldungeon.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	public void live() {
		...
		Buff.affect( this, Hunger.class ).satisfy(1000);
		Buff.affect(this, Thirsty.class).satisfy(1000);
		Buff.affect(this, Weight.class);
		Buff.affect(this,Sp.class);
	}
	...
	public boolean act() {
		...
		if (curAction == null) {
			...
			} else if (curAction instanceof HeroAction.InteractItem) {
				actResult = actInteractItem( (HeroAction.InteractItem)curAction );
	...
	private boolean actInteractItem( HeroAction.InteractItem action ) {

		Heap heap = action.heap;

		if (canInteract(heap)) {

			ready();
			return heap.interact(this);

		} else {

			if (fieldOfView[heap.pos] && getCloser(heap.pos)) {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			EternalPixelDungeon.switchScene(AlchemyScene.class);
			return false;
	...
	private boolean actDescend( HeroAction.Descend action ) {
		...
		} else if ((Dungeon.level.map[pos] == Terrain.EXIT ||Dungeon.level.map[pos] == Terrain.TOWNEXIT || Dungeon.level.map[pos] == Terrain.UNLOCKED_EXIT)) {
	...
	public boolean handle( int cell ) {
		...
		} else if ((cell == Dungeon.level.exit || Dungeon.level.map[cell] == Terrain.EXIT || Dungeon.level.map[cell] == Terrain.UNLOCKED_EXIT || Dungeon.level.map[cell] == Terrain.TOWNEXIT)
				&& Dungeon.depth < 26) {
	...
	public boolean isOverFeed() {
		return Buff.affect(this, Hunger.class).isOverfeed();
	}

	public boolean isOverDrink() {
		return Buff.affect(this, Thirsty.class).isWetting();
	}
