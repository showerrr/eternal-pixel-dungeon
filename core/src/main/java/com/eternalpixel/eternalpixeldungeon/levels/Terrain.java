...
public class Terrain {
	...
	public static final int TOWNEXIT		= 31;
	...
	static {
		...
		flags[SIGN]			= PASSABLE; //Currently these are unused except for visual tile overrides where we want terrain to be solid with no other properties
		flags[WELL]			= AVOID;
		flags[STATUE]		= SOLID;
