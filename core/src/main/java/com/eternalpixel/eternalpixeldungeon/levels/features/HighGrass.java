...
package com.eternalpixel.eternalpixeldungeon.levels.features;
...
import com.eternalpixel.eternalpixeldungeon.actors.mobs.ArmoredStatue;
...
import com.eternalpixel.eternalpixeldungeon.items.food.Berry;
	...
	public static void trample( Level level, int pos ) {
		...
		if (level.map[pos] == Terrain.FURROWED_GRASS){
			...
			if (naturalismLevel >= 0) {
				...
				if (Random.Int(30 - naturalismLevel * 6) == 0) {
					level.drop(Generator.random(Generator.Category.VEGETABLE), pos).sprite.drop();
				}
			}
