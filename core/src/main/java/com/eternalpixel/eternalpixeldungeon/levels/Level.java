...
import com.eternalpixel.eternalpixeldungeon.actors.blobs.WellWater;
...
import com.eternalpixel.eternalpixeldungeon.actors.buffs.LockedFloor;
...
import com.eternalpixel.eternalpixeldungeon.actors.buffs.Shadows;
...
import com.eternalpixel.eternalpixeldungeon.actors.mobs.Bestiary;
import com.eternalpixel.eternalpixeldungeon.actors.mobs.Mob;
import com.eternalpixel.eternalpixeldungeon.actors.mobs.YogFist;
import com.eternalpixel.eternalpixeldungeon.actors.mobs.npcs.Sheep;
import com.eternalpixel.eternalpixeldungeon.effects.particles.FlowParticle;
import com.eternalpixel.eternalpixeldungeon.effects.particles.WindParticle;
...
import com.eternalpixel.eternalpixeldungeon.items.Stylus;
import com.eternalpixel.eternalpixeldungeon.items.Torch;
...
import com.eternalpixel.eternalpixeldungeon.levels.features.HighGrass;
...
public abstract class Level implements Bundlable {
	...
	public void create() {
		...
		if (!(Dungeon.bossLevel())) {
			...
			if (Dungeon.depth % 5 == Dungeon.seed % 5) {
				addItemToSpawn( Generator.random(Generator.Category.COOKINGTOOLS));
			}
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (version < EternalPixelDungeon.v0_9_0b){
	...
	public Heap drop( Item item, int cell ) {
		...
		if (Dungeon.level != null && EternalPixelDungeon.scene() instanceof GameScene) {
			pressCell( cell );
		}
